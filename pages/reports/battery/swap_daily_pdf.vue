                    ...
                    if( resp_count >= 1){
                        ...
                        let info = []
                            result.forEach((element, index, array) => {
                                info.push(
                                    [ index + 1, element.date, element.swaps, element.power_units_kw, element.total,
                                    ])
                            })
                            ...
                            doc.autoTable({
                            head: [[ "No", "Date", "Total Swaps", "units(Kw)", "Revenue (KES)"]],
                            body: info,
                            });
                            // OTHER OPTIONS
                            // theme: 'grid',
                            ...
                            doc.save("batteries_daily_swaps.pdf");
