    ...
    <template #header>
      ...
      <div class="content-header">
        ...
        <div class="d-flex align-items-center">
          <!-- Logo -->
          <nuxt-link to="/" class="font-w600 font-size-h5 tracking-wider text-dual mr-3">
            Crack <span class="font-w400">IT</span>
          </nuxt-link>
          <!-- END Logo -->
        ...
        <div class="d-flex align-items-center">
          ...
          <b-dropdown size="sm" variant="dual" class="d-inline-block ml-2" menu-class="p-0 border-0 font-size-sm" right no-caret ref="oneDropdownBoxedUser">
            <template #button-content>
              <div class="d-flex align-items-center">
                <img class="rounded-circle" src="~/assets/img/avatars/avatar10.jpg" alt="Header Avatar" style="width: 21px;">
            ...
            <li @click="$refs.oneDropdownBoxedUser.hide(true)">
              <div class="p-3 text-center bg-primary-dark rounded-top">
                <img class="img-avatar img-avatar48 img-avatar-thumb" src="~/assets/img/avatars/avatar10.jpg" alt="Avatar">
