...
import nuxt_plugin_encryption_2e42e844 from 'nuxt_plugin_encryption_2e42e844' // Source: ../plugins/encryption.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"GECSS","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_encryption_2e42e844 === 'function') {
    await nuxt_plugin_encryption_2e42e844(app.context, inject)
  }
